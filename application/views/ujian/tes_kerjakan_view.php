...
<div class="container" onclick="openFullscreen();" oncontextmenu='return false' onmousedown='return false' onselectstart='return false' onkeypress='return false'>
	...
	<?php
		$nipd = $this->session->userdata('cbt_tes_user_id');
	?>
		<input type="hidden" value="<?php echo $group;?>" id="nis">
		<input type="hidden" value="<?php echo $nama;?>" id="nisnama">
    	<div class="row">
        <?php echo form_open('tes_kerjakan/simpan_jawaban','id="form-kerjakan"')?>
    		...
    		<div class="box box-success box-solid">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <div class="pull-right">
                            <div id="sisa-waktu" style="background-color: #90EE90"></div>
                        </div>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                ...
                <div class="box-footer">
                    <button type="button" class="btn btn-default hide" id="btn-sebelumnya" onclick="openFullscreen();">Soal Sebelumnya</button>&nbsp;&nbsp;&nbsp;
        ...
        <div class="row">
            <div class="box box-success box-solid">
                ...
                <div class="box-body">
                    ...
                    <p class="help-block">Soal yang sudah dijawab akan berwarna Biru.<br/><b>Update :</b> Tombol <b>Hentikan Tes</b> akan muncul setelah waktu pengerjaan minimal 40 menit. <br/> Apabila setelah 40 menit pengerjaan tombol <b> Hentikan Tes </b> belum muncul, silahkan refresh halaman web.</p>
				</div><!-- /.box-body -->
                <div class="box-footer">
					<input type='submit' value='Hentikan Tes' class='btn btn-default pull-right' id='btn-hentikan'/>
				<!--
				-->
				</div>
            </div><!-- /.box -->
...
//           $("#sisa-waktu").html("Sisa Waktu : "+sisa_menit+" menit");
			var peringatan = ' style="font-size:20px; color:black"';
			if(sisa_detik < 600){
                peringatan = ' style="font-size:20px; color:red"';
			};			
			var jam = Math.floor((sisa_detik)/3600);
			var sisa_jam = sisa_detik % 3600;
			if(jam<10){
				jam = "0"+jam;
			}
			var menit = Math.floor((sisa_jam)/60);
			var sisa_menit = sisa_jam % 60;
			if(menit<10){
				menit = "0"+menit;
			}
			var detik = sisa_menit;
			if(detik<10){
				detik = "0"+detik;
			}
            sisa_detik = sisa_detik-1;
			...
			$("#sisa-waktu").html(
				'<b><p'+peringatan+'>'+"&nbsp;&nbsp;"+jam+" : "+menit+" : "+detik+"&nbsp;&nbsp;"+'</p></b>'
		   );
  ...
  /*              elem = window.top.document.body; //To break out of frame in IE
		...
		function check() {
			if(a>0){
				...
				var nipd = document.getElementById('nis').value;
				var nama = document.getElementById('nisnama').value;
				//var nipd = 12;
				window.location.href = '../../../tes.php?a='+nipd+'&b='+nama;
			}
		}
