            ...
            <div class="box-body">
                <div class="box-body no-padding">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr style="height: 45px;">
                            <td></td>
                            <td style="vertical-align: middle;text-align: right;"><input type="checkbox" required /></td>
                            <td style="vertical-align: middle;">Saya akan mengerjakan ujian dengan jujur.</td>
                            <td></td>
                        </tr>
                  </table>
            </div><!-- /.box-body -->
